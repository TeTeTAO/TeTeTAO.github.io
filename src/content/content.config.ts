...
export const siteContent: SiteContent = {
  ...
  works: [
    ...
    },
    {
      ...
      title: "被植物重新命名的人",
      year: 2025,
      note: "当风和枝叶替他改写轮廓时，他终于从雕刻里逃出来，成为一种更慢的存在。",
      category: "photography",
    },
    {
      id: "photo-03",
      ...
      title: "两匹马在植物里商量方向",
      year: 2025,
      note: "它们没有奔跑，只在叶片的缝隙里低声讨论一条不需要速度的路。",
      category: "photography",
    },
    {
      id: "photo-04",
      ...
      title: "水面练习温柔的方式",
      year: 2025,
      note: "花朵在水里短暂地相遇，把一瞬的颜色交给了比大地更轻的地方。",
      category: "photography",
    },
    {
      id: "photo-05",
    ...
    },
    {
      ...
      title: "四种安静的方式",
      year: 2023,
      note: "它们把世界分成四个角落，每个角落都在练习不同的温柔。",
      category: "photography",
    },
  ],
